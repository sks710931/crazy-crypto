...
contract SleepyGiraffeNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public PRICE = 3 * 10**18; // 3 AVAX
    uint256 public SALE_START = 1655136000; // June 13,  2022, 09:00:00 PDT
    ...
    event CreateSleepyGiraffeNFT(uint256 indexed id);

    constructor(string memory baseURI) ERC721("Sleepy Giraffe", "GIRNFT") {
        setBaseURI(baseURI);
    ...
    function mint(uint256 _count) public payable saleIsOpen {
        ...
        require(total <= MAX_ELEMENTS, "All Sleepy Giraffe NFT's are sold out");
    ...
    function _mintAnElement(address _to) private {
        ...
        _tokenIdTracker.increment();
        _safeMint(_to, id);
        emit CreateSleepyGiraffeNFT(id);
    }
